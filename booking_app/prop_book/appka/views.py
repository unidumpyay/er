...
def edit_room(request):
    ...
    if request.method == 'POST' and request.user.is_staff:
        ...
        hotel = Hotels.objects.all().get(id=int(request.POST['book']))
...
def add_new_room(request):
    ...
    if request.method == "POST":
        ...
        new_room.save()
        messages.success(request,"Новый объект добавлен")
...
def book_room(request):
    ...
    if request.method =="POST":
        ...
        messages.success(request,"Поздравляем! Вы совершили бронирование")
